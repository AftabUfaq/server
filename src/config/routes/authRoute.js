...
const db = require('../connectiion.db');
...
router.post('/signup' , async (req, res) => {
   ...
   var sql = "INSERT INTO `users` (`firstname`, `lastname`, `username`, `password`, `mobilenumber`, `area`, `role`, `cnic`,  `address`, `accountnumber`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?,?)"
   db.getConnection(function (err, db) {
    ...
    // Executing the MySQL query (select all data from the 'users' table).
     db.query(sql, [fname,lname ,username, password, mobilenumber, area, role, cnic, address, accountnumber,], function (error, results, fields) {
